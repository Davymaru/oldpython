...
def create():
    customer = check()
    fname = input("enter the customers first name: ")
    lname = input("enter the customers last name: ")
...
def update():
    lname = input("enter the customers last name to update: ")
    customer = check()
    updated_customer = []
    found = False
    for entry in customer:
...
def delete():
    lname = input("enter the customers last name to delete: ")
    customer = check()
    updated_customer = []
    found = False
    for entry in customer:
